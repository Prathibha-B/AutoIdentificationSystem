...
<title>Bank Employee Registration</title>
</head>
<body>
	<center>
		<style>
			...
			<div class="row">
				<div class="panel">
					<div class="panel-heading">
						<h1>Bank Employee Registration Form</h1>
					</div>
					<div class="panel-body">
						<form action="<%=request.getContextPath()%>/BankEmployeeServlet"
							method="post">
							<table>
								<tr>
									<td>First Name</td>
								...
								<tr>
									...
									<td><input name="Password" id="password" type="password"
										min="5" max="15" size="10" required></td>
								</tr>
								<tr>
						...
						<form
							action="<%=request.getContextPath()%>/BankEmployeeLoginServlet"
							method="post">
